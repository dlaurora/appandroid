...
class TechQuoteRoutesTest {
    ...
    fun routesContainRequiredScreens() {
        val expectedRoutes = setOf(
            ...
            TechQuoteRoutes.CatalogServices,
            TechQuoteRoutes.CatalogServicesInactive,
            TechQuoteRoutes.ServiceDetail,
            TechQuoteRoutes.ServiceForm,
            TechQuoteRoutes.ServiceEdit,
            TechQuoteRoutes.CatalogProducts,
            TechQuoteRoutes.CatalogProductsInactive,
            TechQuoteRoutes.ProductDetail,
            TechQuoteRoutes.ProductForm,
            TechQuoteRoutes.ProductEdit,
            TechQuoteRoutes.Quotes,
            TechQuoteRoutes.QuotesArchived,
            TechQuoteRoutes.QuoteDetail,
            TechQuoteRoutes.QuoteForm,
            TechQuoteRoutes.QuoteEdit,
