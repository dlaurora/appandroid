...
| Room | 2.8.4 | Local client, catalog, and quote persistence | App-private SQLite database | No external transmission | Database excluded from backup; schema migrations 1 -> 2 and 2 -> 3 add catalog and quote tables; evaluate encryption before production sensitive data |
