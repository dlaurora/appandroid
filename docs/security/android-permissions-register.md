...
As of Phase 1, `app/src/main/AndroidManifest.xml` declares no `<uses-permission>` entries.
...
| --- | --- | --- | --- | --- | --- | --- |
| None | No permission required for mock UI shell | App launch and Phase 1 navigation | Keep app permission-free | No restricted data | Low | Keep no permissions |
